            ...
            posts.innerHTML += `
                <div class='review-container'>
                    ...
                    <div class= 'iconDIV-like'>
                        <img class='icon-like btn-like' id='likeIcon${post.id}' data-id='${post.id}'  src='${likedByUser ? '../image/iconPost/heart.svg' : '../image/iconPost/corazon vacio.png'}'><span>${countLikes === 0 ? '' : countLikes}</span></img>
                    </div>
